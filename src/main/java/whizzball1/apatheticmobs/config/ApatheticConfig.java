...
public class ApatheticConfig {
        ...
        public static class RulesCategory {
                ...
                public RulesCategory() {
                        ...
                        revenge = BUILDER.comment(
                                        "If true, mobs will attack you back; if false, they will never attack you back. [false/true|default:false]")
                                        .translation("revenge.apatheticmobs.config").worldRestart()
                                        .define("revenge", false);

                        revengeTime = BUILDER.comment(
                                        "If you have revenge enabled: false -> eternal revenge; true -> temporary revenge.")
                                        .translation("revengetime.apatheticmobs.config").define("revengeTime", false);
                        revengeTimer = BUILDER.comment(
                        ...
                        blacklist = BUILDER.comment(
                                        ...
                                        .translation("blacklist.apatheticmobs.config").define("revengeTime", true);

                        exclusions = BUILDER.comment(
                                        "List of entities that will attack the player if blacklist is enabled.")
                                        .translation("exclusions.apatheticmobs.config").defineList("excluded",
                                                        Arrays.asList(new String[] { "minecraft:cow" }),
                                                        o -> o instanceof String);

                        inclusions = BUILDER.comment(
                                        "List of entities that will not attack the player if blacklist is disabled.")
                                        .translation("inclusions.apatheticmobs.config").defineList("included",
                                                        Arrays.asList(new String[] { "minecraft:zombie" }),
                                                        o -> o instanceof String);

                        difficultyLock = BUILDER.comment(
                        ...
                        difficulties = BUILDER.comment(
                                        "List of entities that will not attack the player if blacklist is disabled.")
                                        .translation("difficulties.apatheticmobs.config").defineList("difficulties",
                                                        Arrays.asList(new String[] { "easy" }),
                                                        o -> o instanceof String);

                        playerWhitelist = BUILDER.comment(
                                        "If you have revenge enabled: false -> eternal revenge; true -> temporary revenge.")
